...
7. Nếu chiến thuật cho phép chi vé, thực hiện mục tiêu đã chọn. Pull 30 chỉ được đi qua tự nhiên trên đường tới một mục tiêu khác; simulator không chọn pull 30 làm mục tiêu chi tiêu riêng.
...
Save & Commit và Yolo chỉ có ngoại lệ sau Featured khi còn từ 1 đến 10 lượt để chạm pull 60. Yolo chỉ cần ví đủ phần thiếu. Save & Commit còn yêu cầu lộ trình `60 hiện tại → 120 banner sau` an toàn; nếu không bảo vệ được 120 banner sau thì dừng ngay dù có đủ vé chạm 60. Pull 30 không còn là mục tiêu chi tiêu riêng của bất kỳ chiến thuật nào. Save & Commit — Roll lẻ vẫn dừng chính xác tại Featured.
...
- Sau Featured, chỉ hoàn tất pull 60 nếu còn tối đa 10 lượt, ví đủ phần thiếu và tổng tài nguyên vẫn bảo vệ được mốc 120 của banner sau; không chi thêm để cố pull 30.
...
- Sau Featured, hoàn tất pull 60 nếu còn tối đa 10 lượt và đủ vé, rồi dừng; Yolo không giữ quỹ cho banner sau và không chi thêm để cố pull 30.
...
### Checkpoint đầu banner: mốc 60

Sau 10 Limited miễn phí và Dossier bắt buộc:

1. Tính số vé cần cho mốc 60.
2. Nếu đủ mốc 60, quay thẳng tới 60.
3. Nếu không đủ mốc 60, skip và giữ vé; không fallback về pull 30.
