...
const srcHtmlPath = join(root, 'A9EGacha.html');
const destHtmlPath = join(release, 'A9EGacha.html');
...
// 2. Create release folder and copy A9EGacha.html
...
await writeFile(`${destHtmlPath}.sha256`, `${checksum}  A9EGacha.html\n`);
